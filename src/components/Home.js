            ...
            <div class="bg-white">
                ...
                <div class="relative pb-32 bg-gray-800">
                    ...
                    <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                        <h1 class="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">Bienvenido a Artempo Studio</h1>
                        <p class="mt-6 max-w-3xl text-xl text-gray-300">tu galería de arte virtual</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
                        <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                            <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-xl font-medium text-gray-900">Pinturas</h3>
                        ...
                        <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                            <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-xl font-medium text-gray-900">Esculturas</h3>
                                {/*<p class="mt-4 text-base text-gray-500">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>*/}
                            </div>
                            <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                                <a href="#" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Ver más<span aria-hidden="true"> &rarr;</span></a>
                        ...
                        <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                            <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-xl font-medium text-gray-900">Booknooks / Dioramas</h3>
                                {/*<p class="mt-4 text-base text-gray-500">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>*/}
                            </div>
                            <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                                <a href="#" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Ver más<span aria-hidden="true"> &rarr;</span></a>
